    ...
    return <div className='container'>

        {
            meaning[0] && textValue && category == 'en' && (
                <audio style={{ backgroundColor: '#fff', width: '100%' }} src={meaning[0].phonetics[0] && meaning[0].phonetics[0].audio} controls>Your Browser is not supporting </audio>
            )

        }


        {textValue === '' ? (<span style={{ fontSize: '20px' }}>START BY TYPING A WORD IN SEARCH</span>) : (
